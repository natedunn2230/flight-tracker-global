...
export default class GlobeComponent  implements OnInit {
    ...
    private createScene() {
        ...
        const material = new ThreeJS.MeshToonMaterial();
        ...
        const box = new ThreeJS.Mesh(
            new ThreeJS.BoxGeometry(1.5, 1.5, 1.5), 
            material
        );
      
        const torus = new ThreeJS.Mesh(
            new ThreeJS.TorusGeometry(5, 1.5, 16, 100),
            material
        );
